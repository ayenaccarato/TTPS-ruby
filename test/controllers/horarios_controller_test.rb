...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference("Horario.count") do
      post horarios_url, params: { horario: { desde: @horario.desde, dia: @horario.dia, hasta: @horario.hasta, sucursal_id: @horario.sucursal_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { desde: @horario.desde, dia: @horario.dia, hasta: @horario.hasta, sucursal_id: @horario.sucursal_id } }
