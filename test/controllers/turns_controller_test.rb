...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { date: @turn.date, motive: @turn.motive, result: @turn.result, status: @turn.status, sucursal_id: @turn.sucursal_id, user_id: @turn.user_id } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { date: @turn.date, motive: @turn.motive, result: @turn.result, status: @turn.status, sucursal_id: @turn.sucursal_id, user_id: @turn.user_id } }
